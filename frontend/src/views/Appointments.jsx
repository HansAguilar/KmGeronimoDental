                                ...
                                patientsData.map(patient => (
                                    <tr className="bg-gray-100 hover:bg-gray-200" key={patient.patientID}>
                                        ...
                                        <td className="p-3 flex items-center justify-around text-sm text-white">
                                            <div className='flex items-center p-1 px-2 bg-[#00cc66] rounded'>
                                            ...
                                            <div className='flex items-center p-1 px-2 rounded bg-[#ff6666]'>
                                            ...
                                            <div className='flex items-center p-1 px-2 bg-gray-700 rounded'>
