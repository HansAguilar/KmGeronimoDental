    ...
    return (
        <aside className="flex flex-col flex-1 gap-8 p-4 bg-[#73949B] text-white font-medium h-full">
            <div className="flex items-center justify-between w-36">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 21 21"><g fill="none" fill-rule="evenodd" stroke="white" stroke-linecap="round" stroke-linejoin="round"><path d="m1.5 10.5l9-9l9 9" /><path d="M3.5 8.5v8a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-8" /></g></svg>
